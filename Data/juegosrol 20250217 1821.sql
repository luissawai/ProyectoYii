...
-- Script date 21/02/2025 10:12:39
-- Server version: 
-- Client version: 4.1
--
...
DROP DATABASE IF EXISTS juegosrol;
...
REFERENCES juegos (idjuegos) ON DELETE CASCADE ON UPDATE CASCADE;
...
REFERENCES jugadores (idjugadores) ON DELETE CASCADE ON UPDATE CASCADE;
...
REFERENCES personajes (idpersonajes) ON DELETE CASCADE ON UPDATE CASCADE;
