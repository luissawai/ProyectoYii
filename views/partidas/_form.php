...
<div class="partidas-form">
    ...
    <?php $form = ActiveForm::begin(['id' => 'form-partidas']); ?>
...
(function () {
    ...
    const form = document.getElementById('form-partidas');
    ...
    // Detectar cambios en inputs, textareas y selects
    ...
    // Si se pulsa guardar, cancelamos la advertencia
    saveButton.addEventListener('click', () => {
        formHasChanged = false;
    });

    // Advertencia si el usuario intenta salir con cambios no guardados
    ...
    // Confirmación personalizada al volver atrás
